...
<html>
<head>
    <title>Register - SecureAuth Pro</title>
        ...
        <div class="max-w-4xl w-full mx-auto grid md:grid-cols-2 gap-8 items-center">
            ...
            <div class="hover-card glass-effect p-8 rounded-2xl">
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-200">Join our secure platform today</p>
                </div>
                ...
                <div class="mt-6 text-center space-y-2">
                    <p class="text-gray-300">
                        ...
                        <a href="login.php" class="text-white hover:underline font-semibold">Login here</a>
                    </p>
